            ...
            FilterChipDefaults.filterChipBorder(
                ...
                disabledBorderColor =
                    MaterialTheme.colorScheme.onBackground.copy(
                        alpha = LudoChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
                    ),
                disabledSelectedBorderColor =
                    MaterialTheme.colorScheme.onBackground.copy(
                        alpha = LudoChipDefaults.DISABLED_CHIP_CONTENT_ALPHA,
                    ),
                selectedBorderWidth = LudoChipDefaults.ChipBorderWidth,
            ),
        colors =
            FilterChipDefaults.filterChipColors(
                ...
                disabledContainerColor =
                    if (selected) {
                        MaterialTheme.colorScheme.onBackground.copy(
                            alpha = LudoChipDefaults.DISABLED_CHIP_CONTAINER_ALPHA,
                        )
                    } else {
                        Color.Transparent
                    },
