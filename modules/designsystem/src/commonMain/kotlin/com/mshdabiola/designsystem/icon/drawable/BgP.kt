...
public val Drawable.BgP: ImageVector
    get() {
        ...
        _bgP = Builder(
            name = "BgP",
            defaultWidth = 723.32.dp,
            defaultHeight = 1600.0.dp,
            viewportWidth = 723.32f,
            ...
            path(
                fill = linearGradient(
                    ...
                    start =
                    Offset(115.15569f, 427.9957f),
                    end = Offset(67.446f, 349.1392f),
                ),
                stroke = null,
            ...
            path(
                fill = linearGradient(
                    ...
                    start =
                    Offset(635.36f, 401.1f),
                    end = Offset(596.21f, 277.0f),
                ),
                stroke = null,
                fillAlpha = 0.7f, strokeAlpha = 0.7f, strokeLineWidth = 0.0f,
                strokeLineCap =
            ...
            path(
                fill = linearGradient(
                    ...
                    start =
                    Offset(387.64f, 639.67f),
                    end = Offset(370.58f, 578.25f),
                ),
                stroke = null,
                fillAlpha = 0.7f, strokeAlpha = 0.7f, strokeLineWidth = 0.0f,
                strokeLineCap =
            ...
            path(
                fill = linearGradient(
                    ...
                    1.0f to Color(0xFFFFFFFF),
                    start =
                    Offset(600.6f, 544.19f),
                    end = Offset(588.78f, 465.13f),
                ),
                stroke = null,
                fillAlpha =
                0.7f,
            ...
            path(
                fill = linearGradient(
                    ...
                    1.0f to Color(0xFFFFFFFF),
                    start =
                    Offset(146.01f, 195.21f),
                    end = Offset(130.59f, 125.48f),
                ),
                stroke = null,
                fillAlpha = 0.7f, strokeAlpha = 0.7f, strokeLineWidth = 0.0f,
                strokeLineCap =
