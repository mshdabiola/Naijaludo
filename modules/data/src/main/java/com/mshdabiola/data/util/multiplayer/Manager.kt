...
//            )
            ...
            Logger.d("start server2")
        } catch (e: Exception) {
            Logger.d("On Server exception")
    ...
    suspend fun onBlueDevice(blueIndex: Int) {
        try {
            ...
            Logger.d("exception in connecting bluetooth")
            onErrorOccurBluetooth(e)
        }
    }
