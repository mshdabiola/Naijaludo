...
fun SettingScreen(settingViewModel: SettingViewModel = hiltViewModel()) {
    val basicSetting by settingViewModel.basic.collectAsStateWithLifecycle()
    val soundSetting by settingViewModel.sound.collectAsStateWithLifecycle()
    val boardSetting by settingViewModel.board.collectAsStateWithLifecycle()
    val profileSetting by settingViewModel.profile.collectAsStateWithLifecycle()
    SettingScreen(
        basicSetting, soundSetting, profileSetting, boardSetting
    )
}
...
fun SettingScreen(
    ...
    Column(
        ...
        SettingContainer {
            ...
            SettingItem(title = "Computer one name") { modifier ->
                MyTextField(
                    modifier = modifier,
            ...
            SettingItem(title = "Computer two name") { modifier ->
                MyTextField(
                    modifier = modifier,
            ...
            SettingItem(title = "Computer three name") { modifier ->
                MyTextField(
                    modifier = modifier,
        ...
        SettingContainer {
            ...
            SettingItem(title = "Pawn Number") { modi ->
                ExposeBox(
                    modifier = modi, current = board.pawnNumber.toString(),
                    onValueChane = {

                        boardSettingChange(board.copy(pawnNumber = it.toInt()))
                    },
                    options = board.numberOfPawn.toImmutableList()
                )
            }
